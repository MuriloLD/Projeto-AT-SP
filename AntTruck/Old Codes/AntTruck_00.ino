...
//----------------------------------------------------------------------------//
  ...
  #define CFG_MIN_USDISTANCE   150 // Minimum US distance [mm]
  ...
  const int TENSAO_NOMINAL_MOTOR = 6;	//Valor utilizado para limitar a tensão 
  					//que incide sobre o motor.
////////////////////////////////////////////////////////////////////////////////
...
*******************************************************************************/
  ...
  bool obstacleDetected(){
    if(     (dist_US_Frente<CFG_MIN_USDISTANCE)
        || (dist_US_Esquerdo<CFG_MIN_USDISTANCE)
        || (dist_US_Direito<CFG_MIN_USDISTANCE) ){
      // changeState("obstacleDetected");
      return true;
    }
    else {
      return false;
...
*******************************************************************************/
  ...
  const int resistor_R1 = 18790, resistor_R2 = 12830; 
  ...
  double calcula_V_Bateria(bool _debug){
    ...
    tensao_Vin = ((tensao_Vin / 10.0)/*margem de erro*/);
...
*******************************************************************************/
  ...
  //Suppot vars for DRIVING state:
  uint32_t DRIVING_now;
  int DRIVING_time;
  double DRIVING_v, DRIVING_w;
  //------------------------------

  //Suppot vars for RUNNING state:
...
*******************************************************************************/
  ...
  char bgn_Str = '>';
  char end_Str = '!';
  // >>[44444444442222]123412341234123412341234123412341234123412121212!!
