...
//----------------------------------------------------------------------------//
  ...
  // Battery Monitoring
  #define CFG_RESISTOR_R1       19300 
  #define CFG_RESISTOR_R2       10250
...
//----------------------------------------------------------------------------//
  ...
  void calcVirtualTarget(double betha){
    int8_t sign;    sign = betha>0 ? 1 : -1;  
  ...
  void stateController(){
    switch(state){
      ...
      case RUNNING :
      {
          ...
          if( dist_US_Direito < CFG_FORCEFIELD_RADIUS){ //In case of obstacle inside the virtual force field:
              betha = -(M_PI/4);
            calcVirtualTarget(betha);
            /* DEBUG:
              Serial.print("Betha: ");
              Serial.print(betha);
              ...
              Serial.println(virtual_y);
            // */
            state = US_OBSTACLE; 
          } 
          else if( dist_US_Esquerdo < CFG_FORCEFIELD_RADIUS){
              betha = M_PI/4;
            calcVirtualTarget(betha);   
            /* DEBUG:
              Serial.print("Betha: ");
          ...
          else if( dist_US_Frente < CFG_FORCEFIELD_RADIUS ){
              betha = 0;
            calcVirtualTarget(betha);    
            /* DEBUG:
              Serial.print("Betha: ");
